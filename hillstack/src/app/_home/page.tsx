					...
					>
							...
							<Box sx={{ p: 2 }}>
								...
								<ul style={{ padding: '14px 20px' }}>
									<li>
										...
										legislation and its impact on the U.S.
										Code.
									</li>
						...
						<Paper elevation={3} sx={{ flex: 1, p: 2 }}>
							<Box>
								...
								<p>
									At its core, the platform bridges the gap
									between raw legislative data and actionable
									insights. It collects and organizes
									information from official government
									sources, presenting it in an easily
									digestible and searchable format. From bill
									summaries to voting records, sponsor
									details, and legislative histories, we
									ensure you have the full context you need at
									your fingertips. For developers, the robust
									API enables seamless integration of
									legislative data into projects, fostering
									innovation and deeper analysis.
								</p>
								<p>
									Transparency and accessibility are at the
									heart of what we do. By demystifying federal
									legislation and making it available to
									everyone, we contribute to a more informed
									and engaged public. Join us in exploring the
									policies that shape our nation and discover
									how this resource can keep you connected to
								...
								>
									...
									>
										...
										<p>
											...
											bills and resolutions shaping the
											nation's future.
										</p>
									...
									>
										...
										<p>
											Track the legislation and lawmakers
											that matter to you.
										</p>
										<Link href='#'>
											<Button
