...
import json
from congress_parser.__main__ import (
    bills,
    app,
    bill_content,
    bill_content_tree,
...
class TestRoutes(TestCase):
    @mock.patch("congress_parser.__main__.get_bills", return_value=[])
    ...
    @mock.patch("congress_parser.__main__.get_bill_contents", return_value=[])
    ...
    @mock.patch("congress_parser.__main__.get_bill_metadata", return_value=[])
    @mock.patch("congress_parser.__main__.get_bill_contents", return_value=[])
    ...
    @mock.patch("congress_parser.__main__.get_chapters", return_value=[])
    ...
    @mock.patch("congress_parser.__main__.get_versions", return_value=[])
    ...
    @mock.patch("congress_parser.__main__.get_revisions", return_value=[])
    ...
    @mock.patch("congress_parser.__main__.get_content_versions", return_value=[])
    @mock.patch("congress_parser.__main__.get_diffs", return_value=[])
    ...
    @mock.patch("congress_parser.__main__.get_latest_sections", return_value=[])
    ...
    @mock.patch(
        "congress_parser.__main__.get_latest_base", return_value=Version(version_id=1)
    )
    @mock.patch("congress_parser.__main__.get_sections", return_value=[])
    ...
    @mock.patch("congress_parser.__main__.get_content", return_value=[])
