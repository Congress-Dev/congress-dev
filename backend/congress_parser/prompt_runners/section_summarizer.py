...
from congress_db.models import LegislationContent, PromptBatch
from congress_db.handler import Session
import json
from congress_parser.utils.logger import LogContext
import jsonschema
from typing import List
from congress_db.models import LegislationContentSummary
from congress_db.handler import Session
...
def section_summarizer(
    ...
    with LogContext(
        ...
        with Session() as session:
            ...
            for lc in legis_content:
                with LogContext(
                    ...
                    if lc.content_type == "legis-body":
                        ...
                        logging.debug(
                            f"Attempting to summarize: {lc.legislation_content_id}"
                        )
            ...
            logging.debug(f"Summarizing all sections for {legislation_version_id}")
            try:
