        ...
        <Card className="page about-us">
            ...
            <Callout>
                ...
                <p>
                    ...
                    datasets, including but not limited to data published by the
                    Library of Congress, the Government Publishing Office (GPO),
                    and official Congressional websites such as congress.gov.
                    These sources supply data on federal legislation, voting
                    records, bill texts, and other legislative materials.
                </p>
                <p>
                    This site operates as an independent platform that
                    organizes, parses, and presents this data for public use.
                    While we strive to maintain accuracy and up-to-date
                    information, no warranties are made regarding the
                    completeness, accuracy, or timeliness of the data. Users are
                    encouraged to verify details by cross-referencing the
                    information with official sources.
                </p>
                <p>
                    All legislative data presented here is made available under
                    applicable laws governing public domain content, ensuring it
                    can be freely accessed and utilized by individuals and
            ...
            <Callout>
                ...
                <ol className="faq">
                    <li>
                        ...
                        information is available. Most updates occur in real
                        time or within a few hours of changes being published by
                    ...
                    <li>
                        ...
                        specific bills, topics, or keywords. Additionally, users
                        can sign up for alerts to receive updates on legislation
                        of interest.
                    </li>
                    <li>
                        ...
                        ensuring a high degree of accuracy. However, we
                        recommend cross-referencing with the original sources
                    ...
                    <li>
                        ...
                        <a href="mailto:admin@congress.dev">contact us</a> to
                        reach out.
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        domain datasets and can be freely used under applicable
                        laws. Be sure to review the terms of use for the
